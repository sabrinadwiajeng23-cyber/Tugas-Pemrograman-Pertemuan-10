...
Deskripsi
Program untuk mengelola data nilai mahasiswa menggunakan Dictionary Python. Program dapat menambah, mengubah, menghapus, menampilkan, dan mencari data mahasiswa.

1.  *START:* Inisialisasi Dictionary kosong data_mahasiswa.
2.  *Loop Utama (Menu):* Tampilkan Menu Pilihan (Tambah, Ubah, Hapus, Tampil, Cari, Keluar).
3.  *Input Pilihan:* Minta input pilihan dari pengguna.
4.  *Percabangan (Switch/If-Else):*
...
![alt image] (https://github.com/sabrinadwiajeng23-cyber/Tugas-Pemrograman-Pertemuan-10/blob/main/Flowchart_.png)
